...
const WasmCalculatorFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmcalculator_free(ptr >>> 0, 1));
...
export class WasmCalculator {
    ...
    evaluate(expression) {
        try {
            ...
            wasm.wasmcalculator_evaluate(retptr, this.__wbg_ptr, ptr0, len0);
     ...
     */
    get_result() {
        const ret = wasm.wasmcalculator_get_result(this.__wbg_ptr);
        return ret;
    }
}
